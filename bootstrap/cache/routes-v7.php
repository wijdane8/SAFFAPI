...
app('router')->setCompiledRoutes(
  ...
  array (
    ...
    2 => 
    array (
      0 => '{^(?|/api/(?|expenses/([^/]++)(?|(*:35))|account(?|\\-types/([^/]++)(*:69)|s/([^/]++)(?|(*:89)))))/?$}sDu',
    ),
    3 => 
    array (
      35 => 
  ...
  array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Api\\AuthController@resetOtp',
        'controller' => 'App\\Http\\Controllers\\Api\\AuthController@resetOtp',
        'namespace' => NULL,
        'prefix' => 'api',
        'where' => 
        array (
        ),
        'as' => 'api.auth.reset.otp',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Api\\AuthController@otp',
        'controller' => 'App\\Http\\Controllers\\Api\\AuthController@otp',
        'namespace' => NULL,
        'prefix' => 'api',
        'where' => 
        array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Api\\AccountTypeController@index',
        'controller' => 'App\\Http\\Controllers\\Api\\AccountTypeController@index',
        'namespace' => NULL,
        'prefix' => 'api',
        'where' => 
        array (
        ),
        'as' => 'api.account.type.index',
      ),
      'fallback' => false,
      'defaults' => 
      array (
    ...
    array (
      ...
      array (
        ...
        'uses' => 'App\\Http\\Controllers\\Api\\AccountTypeController@show',
        'controller' => 'App\\Http\\Controllers\\Api\\AccountTypeController@show',
        'namespace' => NULL,
        'prefix' => 'api',
        'where' => 
        array (
        ),
        'as' => 'api.account.type.show',
      ),
      'fallback' => false,
      'defaults' => 
      array (
